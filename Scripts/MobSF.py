...
input_file = "/Users/digitalsecurity/PycharmProjects/automation_tool/test_run/com.ibm.android.analyzer.test/10_08_2018_16_53_51/input/2018.06.08.ipa"
...
def scan_input_file():
    ...
    try:
        ...
        if app_scan_build.status_code == 200:
            ...
            print (f"Failed scan the application, error message : {app_scan_build.content}")
    except Exception as error:
        print(error)
...
def download_report_as_dictionary():
    ...
    try:
        ...
        if app_report_json.status_code == 200:
            ...
            print(f"Failed scan the application, error message : {app_report_json.content}")
    except Exception as error:
        print(error)
...
def download_report_as_PDF():
    ...
    try:
        ...
        if app_report_pdf.status_code == 200:
            ...
            print(f"Failed scan the application, error message : {app_report_pdf.content}")
    except Exception as error:
        print(error)
